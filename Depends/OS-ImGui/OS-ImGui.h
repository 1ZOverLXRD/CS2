...
namespace OSImGui
{
	...
	{
	public:
		ID3D11ShaderResourceView* LoadTextureFromFile(const char* filename, int& out_w, int& out_h);
		void DrawImage( ID3D11ShaderResourceView* texture, const ImVec2& pos, const ImVec2& size);
		// 文本

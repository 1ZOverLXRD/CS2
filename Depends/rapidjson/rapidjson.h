...
#endif
#define RAPIDJSON_SETPOINTER(T, p, x) (p = reinterpret_cast<T *>((reinterpret_cast<uintptr_t>(p) & static_cast<uintptr_t>(RAPIDJSON_UINT64_C2(0xFFFF0000, 0x00000000))) | reinterpret_cast<uintptr_t>(reinterpret_cast<const void*>(x))))
#define RAPIDJSON_GETPOINTER(T, p) (reinterpret_cast<T *>(reinterpret_cast<uintptr_t>(p) & static_cast<uintptr_t>(RAPIDJSON_UINT64_C2(0x0000FFFF, 0xFFFFFFFF))))
#else
#define RAPIDJSON_SETPOINTER(T, p, x) (p = (x))
#define RAPIDJSON_GETPOINTER(T, p) (p)
#endif
